...
mw.PluginManager.add( 'debugInfo', mw.KBaseComponent.extend({
    ...
    setVisible:function(visible) {
        ...
        if (visible) {
            var debugObject = parent.document;
            $(debugObject).find('#appendStats').prepend("<div class='mw-debug-info'>");
            var elem = parent.document.getElementsByClassName("mw-debug-info")[0];
